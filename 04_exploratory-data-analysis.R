...
pdf("SP_plot.pdf", width = 6, height = 4)
plot(year_SP, SPreturn,
  main = "S&P 500 daily returns", xlab = "year", type = "l",
  ylab = "log return"
)
graphics.off()

pdf("DM_plot.pdf", width = 6, height = 4)
plot(year_dm, diffdm,
  xlab = "year", ylab = "change in rate", main =
    "changes inDM/dollar exchange rate", type = "l"
)
graphics.off()

pdf("rf_plot.pdf", width = 6, height = 4)
plot(year_rf, diffrf,
  main = "changes in risk-free interest return", xlab = "year",
  ylab = "change in rate", type = "l"
)
graphics.off()

pdf("SP_hist.pdf", width = 7, height = 6)
par(mfrow = c(2, 2))
hist(SPreturn,
  breaks = 30, xlab = "return",
  main = "(a) 30 cells, full range"
)
hist(SPreturn,
  breaks = 30, main = "(b) 30 cells, central range",
  xlim = c(-.04, .04), xlab = "return"
) # ,cex.main=1.5)
hist(SPreturn,
  breaks = 20, main = "(c) 20 cells, central range",
  xlim = c(-.04, .04), xlab = "return",
)
hist(SPreturn,
  breaks = 50, main = "(d) 50 cells, central range",
  xlim = c(-.04, .04), xlab = "return"
)
graphics.off()
...
## Figure 4.5 ----
pdf("constructingKDE.pdf", width = 6, height = 8)
set.seed("992291")
x <- rnorm(6)
l <- matrix(1, 200, 6)
l2 <- l
...
## Figure 4.6 ----
pdf("SP_density.pdf", width = 7, height = 5)
par(mfrow = c(1, 1))
data(SP500, package = "Ecdat")
SPreturn <- SP500$r500
plot(density(SPreturn, kernel = "gaussian", adjust = 1),
  xlim = c(-.04, .04),
...
legend(-.04, 45, c("adjust=1", "adjust=1/3", "adjust=3"),
  lty = c(1, 2, 4),
...
## Figure 4.7 ----
pdf("SP_density_norm.pdf", width = 10, height = 7)
par(mfrow = c(1, 2))
data(SP500, package = "Ecdat")
SPreturn <- SP500$r500
plot(density(SPreturn, kernel = "gaussian"),
  xlim = c(-.06, .06),
...
legend(-.065, 63, c("estimated density", "normal density"),
  lty = c(1, 2), cex = 1.5,
...
## Figure 4.9 ----
pdf("convex_concave.pdf", width = 6, height = 5)
x <- (1:299) / 300
f1 <- exp(3 * x)
f2 <- log(x + .01)
f3 <- qnorm(x)
...
## Figure 4.10 ----
pdf("normal_plots_normal.pdf")
par(mfrow = (c(3, 2)))
set.seed("543")
x1 <- rnorm(20)
qqnorm(x1, datax = TRUE, main = "n = 20")
qqline(x1, datax = TRUE)
x1 <- rnorm(20)
qqnorm(x1, datax = TRUE, main = "n = 20")
qqline(x1, datax = TRUE)
x1 <- rnorm(150)
qqnorm(x1, datax = TRUE, main = "n = 150")
qqline(x1, datax = TRUE)
x1 <- rnorm(150)
qqnorm(x1, datax = TRUE, main = "n = 150")
qqline(x1, datax = TRUE)
x1 <- rnorm(1000)
qqnorm(x1, datax = TRUE, main = "n = 1000")
qqline(x1, datax = TRUE)
x1 <- rnorm(1000)
qqnorm(x1, datax = TRUE, main = "n = 1000")
qqline(x1, datax = TRUE)
...
## Figure 4.11 ----
pdf("normal_plots_lognormal.pdf")
par(mfrow = (c(3, 2)))
set.seed("864")
x1 <- rlnorm(150, sd = 1)
qqnorm(x1, datax = TRUE, main = expression(paste("n=150, ", sigma, " = 1")))
qqline(x1, datax = TRUE)
x1 <- rlnorm(1000, sd = 1)
qqnorm(x1, datax = TRUE, main = expression(paste("n=1000, ", sigma, " = 1")))
qqline(x1, datax = TRUE)
x1 <- rlnorm(150, sd = 1 / 2)
qqnorm(x1, datax = TRUE, main = expression(paste("n=150, ", sigma, " = 1/2")))
qqline(x1, datax = TRUE)
x1 <- rlnorm(1000, sd = 1 / 2)
qqnorm(x1, datax = TRUE, main = expression(paste("n=1000, ", sigma, " = 1/2")))
qqline(x1, datax = TRUE)
x1 <- rlnorm(150, sd = 1 / 5)
qqnorm(x1, datax = TRUE, main = expression(paste("n=150, ", sigma, " = 1/5")))
qqline(x1, datax = TRUE)
x1 <- rlnorm(1000, sd = 1 / 5)
qqnorm(x1, datax = TRUE, main = expression(paste("n=1000, ", sigma, " = 1/5")))
qqline(x1, datax = TRUE)
graphics.off()


## Figure 4.12 ----
pdf("normal_plots_t.pdf")
par(mfrow = (c(3, 2)))
set.seed("7290")
x1 <- rt(150, df = 4)
qqnorm(x1, datax = TRUE, main = "n=150, df=4")
qqline(x1, datax = TRUE)
x1 <- rt(1000, df = 4)
qqnorm(x1, datax = TRUE, main = "n=150, df=4")
qqline(x1, datax = TRUE)
x1 <- rt(150, df = 10)
qqnorm(x1, datax = TRUE, main = "n=150, df=10")
qqline(x1, datax = TRUE)
x1 <- rt(1000, df = 10)
qqnorm(x1, datax = TRUE, main = "n=150, df=10")
qqline(x1, datax = TRUE)
x1 <- rt(150, df = 30)
qqnorm(x1, datax = TRUE, main = "n=150, df=30")
qqline(x1, datax = TRUE)
x1 <- rt(1000, df = 30)
qqnorm(x1, datax = TRUE, main = "n=150, df=30")
qqline(x1, datax = TRUE)
...
## Figure 4.13 ----
pdf("Bimodal_QQ.pdf", width = 7, height = 4)
set.seed(997733)
...
par(mfrow = c(1, 1))
halfnorm(abs(diffdm),
  main = "changes in DM/dollar exchange rate",
  ylab = "Sorted data"
)
graphics.off()
...
## Figure 4.15 ----
pdf("SP_qqnorm.pdf", width = 5, height = 7)
par(mfrow = c(3, 2))
qqnorm(SPreturn,
  datax = TRUE, ylab = "Data", xlab = "normal quantiles",
...
## Figure 4.16 ----
pdf("sampleQQplots.pdf", width = 6, height = 6)
par(mfrow = c(2, 2))
...
pdf("boxplots.pdf")
par(mfrow = c(1, 1))
boxplot(list(SPreturn, diffdm, diffrf),
  boxwex = .5,
...
## Figure 4.19 ----
pdf("risk_free_w_w0_log.pdf", width = 6, height = 6)
par(mfrow = c(2, 2))
plot(Capm$rf[-1], diff(Capm$rf),
  xlab = "lagged rate", ylab = "change in rate",
  main = "(a)"
)
plot(year_rf, diff(Capm$rf),
  xlab = "year", ylab = "change in rate",
  main = "(b)"
)
plot(Capm$rf[-1], diff(log(Capm$rf)),
  xlab = "lagged rate", ylab = "change in log rate",
  main = "(c)"
)
plot(diff(log(Capm$rf)),
  xlab = "year", ylab = "change in log rate",
  main = "(d)"
)
graphics.off()
...
## Figure 4.21 ----
pdf("GasFlowsTransHist.pdf", width = 6, height = 4.5)
x1 <- dat$Flow1
par(mfrow = c(2, 3))
...
## Figure 4.22 ----
pdf("ttest_lognormal.pdf", width = 7, height = 4)
set.seed("119933")
...
pdf("DerRatio.pdf", width = 6, height = 5)
par(mfrow = c(1, 1))
plot(lambda, 2^(lambda - 1),
  type = "l", lwd = 2, xlab = expression(alpha),
...
## Figure 4.26 ----
pdf("risk_free_var_stabilize.pdf", width = 6, height = 5)
...
par(mfrow = c(1, 1))
plot(alpha, result_abs,
  lty = 1, type = "l", xlab = expression(alpha),
  ylab = "correlation",
  lwd = 2
)
...
## Figure 4.27 ----
pdf("Earning_TKDE.pdf", width = 6, height = 5)
...
par(mfrow = c(1, 1))
plot(f$x[ind2], f$y[ind2],
  type = "l", ylim = c(0, .035), xlim = c(0, 100),
  ylab = "Density(y)", xlab = "y=income (in $1000)", lwd = 2
)
abline(h = 0)
f2 <- 0.5 * froot$y / froot$x
lines(froot$x[ind2]^2, f2[ind2],
  type = "l",
...
pdf("Earning_hist.pdf", width = 7, height = 4)
par(mfrow = c(1, 2))
y <- x
hist(y)
hist(sqrt(y))
...
for (i in colnames(logR)) {
  qqnorm(logR[, i], datax = TRUE, main = i)
  qqline(logR[, i], datax = TRUE)
